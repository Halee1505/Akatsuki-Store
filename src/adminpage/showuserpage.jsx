...
export default function ShowUserPage() {
  ...
  useEffect(() => {
    axios.get("http://localhost/api/customer/read.php").then((res) => {
      setUsers(res.data);
    });
  ...
  function uploadBan(user) {
    ...
    axios
      .put("http://localhost/api/customer/update.php?cid=" + user.cid, newUser)
      .then((res) => {
  ...
  function DeleteUser(user) {
    ...
    axios
      .get("http://localhost/api/customer/delete.php?cid=" + user.cid)
      .then((res) => {
        console.log(res);
